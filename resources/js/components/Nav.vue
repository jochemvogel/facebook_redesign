<template>
    <div class="bg-white h-12 px-3 flex items-center text-gray-700 border-b border-gray-400 shadow-sm">
        ...
        <div class="sm:w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    <div class="absolute text-gray-600 hover:text-gray-700">
                    ...
                    <input type="text" name="search" class="rounded-full pl-8 w-48 bg-gray-200 h-8 focus:outline-none focus:shadow-outline text-xs" placeholder="Search Facebook">
                </div>
            </div>
        </div>

        <!-- Middle Section -->
        <div class="w-full flex flex-row justify-center items-center sm:h-full fixed bottom-0 sm:static z-50 bg-white border-t-2 border-gray-300 -ml-4 pl-4 sm:m-0 sm:p-0  ">
            <!-- Home-->
            <router-link to="/" class="px-6 border-t-2 rounded-t-sm sm:border-b-2 sm:border-t-0 border-blue-500 h-full flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5"><path d="M22.6 11l-9.9-9c-.4-.4-1.1-.4-1.5 0l-9.9 9c-.3.3-.5.8-.3 1.2.2.5.6.8 1.1.8h1.6v9c0 .4.3.6.6.6h5.4c.4 0 .6-.3.6-.6v-5.5h3.2V22c0 .4.3.6.6.6h5.4c.4 0 .6-.3.6-.6v-9h1.6c.5 0 .9-.3 1.1-.7.3-.5.2-1-.2-1.3zm-2.5-8h-4.3l5 4.5V3.6c0-.3-.3-.6-.7-.6z" fill="#4a5568"/></svg>
            </router-link>

            <!-- Profile Picture -->
            <router-link to="/" class="px-6 border-t-2 sm:border-b-2  sm:border-t-0 border-white h-full flex items-center">
                <img src="https://images.pexels.com/photos/736716/pexels-photo-736716.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Smiling man" class="w-8 h-8 object-cover rounded-full">
            </router-link>
            <!-- Messenger -->
            <router-link to="/" class="px-6 border-t-2 sm:border-b-2 sm:border-t-0 border-white h-full flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5"><path d="M.5 11.6c0 3.4 1.7 6.3 4.3 8.3V24l3.9-2.1c1 .3 2.2.4 3.3.4 6.4 0 11.5-4.8 11.5-10.7C23.5 5.8 18.3 1 12 1S.5 5.8.5 11.6zm10.3-2.9l3 3.1 5.6-3.1-6.3 6.7-2.9-3.1-5.7 3.1 6.3-6.7z" fill="#4a5568"/></svg>
            </router-link>
            <!-- Hamburger -->
            <router-link to="/" class="px-6 sm:hidden justify-end items-end">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="fill-current w-6 h-6"><path d="M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z" fill="#4a5568"/></svg>
            </router-link>
        </div>
